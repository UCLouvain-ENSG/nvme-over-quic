			  ...
			  const struct spdk_json_val *params)
{
	...
	spdk_json_write_named_bool(w, "tls_writev_flatten", sock_opts.tls_writev_flatten);
...
static const struct spdk_json_object_decoder rpc_sock_impl_set_opts_decoders[] = {
	...
	{
		"tls_writev_flatten", offsetof(struct spdk_rpc_sock_impl_set_opts, sock_opts.tls_writev_flatten),
		spdk_json_decode_bool, true
	}
};
