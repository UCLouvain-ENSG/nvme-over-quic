...
# Usage: ./perf_test_tcp.sh [-q QUEUE_DEPTH] [-o BLOCK_SIZE] [-w WORKLOAD] [-t TEST_TIME]
...
echo "Running TCP test: QD=$QUEUE_DEPTH, BS=$BLOCK_SIZE, Workload=$WORKLOAD, Time=${TEST_TIME}s..."
