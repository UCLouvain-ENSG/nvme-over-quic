...
#define TRACE_GROUP_NVMF_QUIC	0x7
...
#define TRACE_GROUP_NVME_QUIC	0x13
...
/* NVMe QUIC tracepoint definitions */
#define TRACE_NVME_QUIC_SUBMIT		SPDK_TPOINT_ID(TRACE_GROUP_NVME_QUIC, 0x0)
#define TRACE_NVME_QUIC_COMPLETE	SPDK_TPOINT_ID(TRACE_GROUP_NVME_QUIC, 0x1)
...
/* NVMe-of QUIC tracepoint definitions */
#define TRACE_QUIC_REQUEST_STATE_NEW				SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x00)
#define TRACE_QUIC_REQUEST_STATE_NEED_BUFFER			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x01)
#define TRACE_QUIC_REQUEST_STATE_HAVE_BUFFER			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x02)
#define TRACE_QUIC_REQUEST_STATE_AWAIT_ZCOPY_START		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x03)
#define TRACE_QUIC_REQUEST_STATE_ZCOPY_START_COMPLETED		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x04)
#define TRACE_QUIC_REQUEST_STATE_TRANSFERRING_HOST_TO_CONTROLLER	SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x05)
#define TRACE_QUIC_REQUEST_STATE_READY_TO_EXECUTE		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x06)
#define TRACE_QUIC_REQUEST_STATE_EXECUTING			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x07)
#define TRACE_QUIC_REQUEST_STATE_AWAIT_ZCOPY_COMMIT		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x08)
#define TRACE_QUIC_REQUEST_STATE_EXECUTED			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x09)
#define TRACE_QUIC_REQUEST_STATE_READY_TO_COMPLETE		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x0a)
#define TRACE_QUIC_REQUEST_STATE_TRANSFERRING_CONTROLLER_TO_HOST	SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x0b)
#define TRACE_QUIC_REQUEST_STATE_AWAIT_ZCOPY_RELEASE		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x0c)
#define TRACE_QUIC_REQUEST_STATE_COMPLETED			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x0d)
#define TRACE_QUIC_READ_FROM_SOCKET_DONE			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x0f)
#define TRACE_QUIC_REQUEST_STATE_AWAIT_R2T_ACK			SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x10)
#define TRACE_QUIC_QP_CREATE					SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x11)
#define TRACE_QUIC_QP_SOCK_INIT					SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x12)
#define TRACE_QUIC_QP_STATE_CHANGE				SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x13)
#define TRACE_QUIC_QP_DISCONNECT				SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x14)
#define TRACE_QUIC_QP_DESTROY					SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x15)
#define TRACE_QUIC_QP_ABORT_REQ					SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x16)
#define TRACE_QUIC_QP_RCV_STATE_CHANGE				SPDK_TPOINT_ID(TRACE_GROUP_NVMF_QUIC, 0x17)
